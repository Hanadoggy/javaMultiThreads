...
public class ProductReviewsService {
    ...
    private ReentrantReadWriteLock reviewLock = new ReentrantReadWriteLock();
    private Lock readProductLock = productLock.readLock();
    private Lock writeProductLock = productLock.writeLock();
    private Lock readReviewLock = reviewLock.readLock();
    private Lock writeReviewLock = reviewLock.writeLock();
